 ...
 * @author Admin
 */
@WebServlet(name = "ok", urlPatterns = {"/ok"})
public class postAComment extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (session.getAttribute("id") == null) {
            ...
            } else if (request.getParameter("comment").isEmpty() || request.getParameter("comment") == null) {
                ...
                DAO d = new DAO();
                d.addComment(idPost, idZalo, comment);
                request.getRequestDispatcher("/showPost").forward(request, response);
            }
        }
    }
