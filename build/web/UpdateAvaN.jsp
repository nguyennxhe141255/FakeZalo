        ...
        <div style="margin: 0 auto; width: 40%;
            ...
            <form action="Upload" method="post" enctype="multipart/form-data">
                <div style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);padding: 30px; border-radius: 10px">
                    ...
                    <div>
                        <body>
                            <div id='first_element'>
                                <img style="width: 100%;height: 200px;" src="images/<%=background%>">
                            </div>
                        <center>
                    ...
                    <br><br>
                    <center>
                        <div style="display: flex;padding-left: 35%;bottom: 50px">
                            <div style="display: flex"><b style="font-size: 13px"><em><input  style="height: 15px;width: 15px" type="radio" name="radio"  required value="yes">Upload</em></b></div>
                            <div style="display: flex; padding-left: 20px"><b style="font-size: 13px"><em><input  style="height: 15px;width: 15px"  type="radio" name="radio" required value="no">no upload</em></b></div>
                        </div>
